...
namespace ContosoMvcApp.DAL
{
    public class SchoolInitializer:DropCreateDatabaseAlways<SchoolDBContext>
    {
        protected override void Seed(SchoolDBContext context)
        {
            ...
            {
                new Department { Name = "English",     Budget = 350000, StartTime = DateTime.Parse("2007-09-01"), InstructorID = 1 },
                new Department { Name = "Mathematics", Budget = 100000, StartTime = DateTime.Parse("2007-09-01"), InstructorID = 2 },
                new Department { Name = "Engineering", Budget = 350000, StartTime = DateTime.Parse("2007-09-01"), InstructorID = 3 },
                new Department { Name = "Economics",   Budget = 100000, StartTime = DateTime.Parse("2007-09-01"), InstructorID = 4 }
            };
